  ...
  "threads": [
    {
      ...
      "reply_count": 3,
      "messages": [
        { "user": "田中太郎", "text": "...", "ts": "...", "date": "2024-01-01" },
        { "user": "佐藤花子", "text": "...", "ts": "...", "date": "2024-01-01" }
      ],
      "permalink": "https://app.slack.com/archives/C12345/p1704067200000000"
    }
  ],
  "standalone_messages": [
    { "user": "田中太郎", "text": "スレッドなしの単独メッセージ", "ts": "...", "date": "2024-01-01" }
  ],
  "metadata": {
